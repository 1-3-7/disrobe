import { brand, palette } from "./brand.mjs";
...
export const C = {
  ...
  teal: brand.semantic.dark.success,
  blue: brand.semantic.dark.detection,
  amber: brand.semantic.dark.partial,
  orange: brand.semantic.dark.experimental,
  red: brand.semantic.dark.danger,
};

export const SANS = `'${brand.body}', sans-serif`;
export const MONO = `'${brand.code}', monospace`;
