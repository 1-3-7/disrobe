...
| Containers, firmware | Recover | <!-- roster-breadth:containers-exercised -->35<!-- /roster-breadth --> of <!-- roster-breadth:containers-declared -->101<!-- /roster-breadth --> declared formats write member bytes from a committed input | measured `[CI]` | [containers](docs/src/languages/containers.md) |
...
| Container / archive / firmware extraction | <!-- roster-breadth:containers-exercised -->35<!-- /roster-breadth --> of <!-- roster-breadth:containers-declared -->101<!-- /roster-breadth --> declared formats reached by a committed input `[CI]` | extraction over the committed corpus | `crates/disrobe-cli/tests/container_breadth.rs` |
...
| Metric | Measured | Oracle | Reproduce |
|---|---|---|---|
| Android DEX, real APKs `coverage-self-reported` | <!-- m:dalvik_body_pct -->92.6%<!-- /m --> of defined methods `[local]` | self-reported, gitignored apks | `crates/disrobe-pass-jvm/tests/dex2jar_realworld_apks.rs` |
| Android DEX, real APKs, count `coverage-self-reported` | <!-- m:dalvik_body_frac -->82906 / 89516<!-- /m --> `[local]` | self-reported, gitignored apks | `crates/disrobe-pass-jvm/tests/dalvik_realworld_body_attest.rs` |
...
The recovered bodies that can be presented to the verifier are attested at <!-- m:dalvik_body_attested_frac -->2975 of 2989<!-- /m -->, graded by real `java -Xverify:all` over bodies rather than methods, which is a different and smaller population than the method-coverage figure above.
...
| <!-- evidence-pair:apk-jadx-cfr:dex -->Android DEX | 52 / 165 methods recompile | JADX 1.5.5: not certified: 295 methods emitted | no lead: the JADX output is not certified (the producer exited nonzero) | `cargo run --locked -p disrobe-bench-head-to-head -- --check --only apk-jadx-cfr`<!-- /evidence-pair --> |
