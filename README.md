...
| Containers, firmware | Recover | <!-- roster-breadth:containers-exercised -->34<!-- /roster-breadth --> of <!-- roster-breadth:containers-declared -->100<!-- /roster-breadth --> declared formats write member bytes from a committed input | measured `[CI]` | [containers](docs/src/languages/containers.md) |
...
| Container / archive / firmware extraction | <!-- roster-breadth:containers-exercised -->34<!-- /roster-breadth --> of <!-- roster-breadth:containers-declared -->100<!-- /roster-breadth --> declared formats reached by a committed input `[CI]` | extraction over the committed corpus | `crates/disrobe-cli/tests/container_breadth.rs` |
