...
| Containers, firmware | Recover | <!-- roster-breadth:containers-exercised -->33<!-- /roster-breadth --> of <!-- roster-breadth:containers-declared -->100<!-- /roster-breadth --> declared formats write member bytes from a committed input | measured `[CI]` | [containers](docs/src/languages/containers.md) |
