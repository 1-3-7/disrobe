...
| <!-- evidence-pair:apk-jadx-cfr:dex -->Android DEX | 60 / 163 methods recompile | JADX 1.5.5: not certified: 295 methods emitted | no lead: the JADX output is not certified (the producer exited nonzero) | `cargo run --locked -p disrobe-bench-head-to-head -- --check --only apk-jadx-cfr`<!-- /evidence-pair --> |
