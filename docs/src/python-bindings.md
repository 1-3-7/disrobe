...
200-module corpus is <!-- m:py_stdlib_pinned_pct -->96.6%<!-- /m --> (<!-- m:py_stdlib_pinned_count -->6072 of 6286<!-- /m -->, CI floor 96.60%). Legacy CPython
...
<!-- roster-breadth:containers-exercised -->34<!-- /roster-breadth --> of them are driven to member
