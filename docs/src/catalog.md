...
| **Containers / archives / filesystems / firmware** | <!-- m:containers_formats -->101<!-- /m --> formats detected, all <!-- m:containers_formats -->101<!-- /m --> carrying an in-tree extractor. <!-- roster-breadth:containers-exercised -->41<!-- /roster-breadth --> of them are driven to member bytes by an input this repository commits; the remainder are declared rather than measured. |
