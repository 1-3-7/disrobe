...
| `disrobe native diff <a> <b>` | Match functions across two builds by content + CFG fingerprint. Native images only; for other languages use [`disrobe semdiff`](#semdiff). |
