...
<!-- m:py_stdlib_pinned_pct -->95.61%<!-- /m --> (5,920 of 6,286 code objects), precisely because it over-represents recoverable modules; the
...
over the 200-module pinned corpus (the source of the <!-- m:py_stdlib_pinned_pct -->95.61%<!-- /m --> and 54.5% figures), parses its JSON, and
