...
<!-- m:py_stdlib_pinned_pct -->96.53%<!-- /m --> (<!-- m:py_stdlib_pinned_count_grouped -->6,068 of 6,286<!-- /m --> code objects), precisely because it over-represents recoverable modules; the
...
over the 200-module pinned corpus behind both the 96.51% and the 61.5% figures used as regression floors, parses its JSON, and
