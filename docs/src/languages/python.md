...
| Decompilation | In-house engine across CPython 1.0-3.15 with per-version opcode dispatch; <!-- m:py_stdlib_full_pct -->95.09%<!-- /m --> per-code-object recompile-equivalence on the full CPython 3.14 stdlib (<!-- m:py_stdlib_full_count -->17378 of 18276<!-- /m -->), <!-- m:py_stdlib_pinned_pct -->96.53%<!-- /m --> on the pinned 200-module corpus (<!-- m:py_stdlib_pinned_count -->6068 of 6286<!-- /m -->, above a 96.51% floor a committed CI gate enforces on tag and scheduled runs), and the legacy 1.0-3.7 band asserts a floor, enforced on the same runs, of <!-- m:py_legacy_count -->150 of 191<!-- /m --> proven-correct (<!-- m:py_legacy_local_count -->166 of 191<!-- /m --> measured locally with the period interpreter zoo: 67 by recompile-equivalence, 99 by structural token-match) |
...
|---|---|---|---|---|---|
| 3.10 | CPython <!-- m:py_band_310_interpreter -->3.10.20<!-- /m --> | <!-- m:py_band_310_frac -->5226 / 5458<!-- /m --> code objects | <!-- m:py_band_310_rate -->95.74%<!-- /m --> | <!-- m:py_band_310_modules -->161<!-- /m --> | push, tag, schedule |
...
| 3.12 | CPython <!-- m:py_band_312_interpreter -->3.12.13<!-- /m --> | <!-- m:py_band_312_frac -->5408 / 5659<!-- /m --> code objects | <!-- m:py_band_312_rate -->95.56%<!-- /m --> | <!-- m:py_band_312_modules -->177<!-- /m --> | tag, schedule |
| 3.13 | CPython <!-- m:py_band_313_interpreter -->3.13.14<!-- /m --> | <!-- m:py_band_313_frac -->5721 / 5966<!-- /m --> code objects | <!-- m:py_band_313_rate -->95.89%<!-- /m --> | <!-- m:py_band_313_modules -->190<!-- /m --> | tag, schedule |
| 3.14 | CPython <!-- m:py_band_314_interpreter -->3.14.5<!-- /m --> | <!-- m:py_band_314_frac -->6068 / 6286<!-- /m --> code objects | <!-- m:py_band_314_rate -->96.53%<!-- /m --> | <!-- m:py_band_314_modules -->200<!-- /m --> | no band gate, mirrored |
| 3.15 | CPython <!-- m:py_band_315_interpreter -->3.15.0b4<!-- /m --> | <!-- m:py_band_315_frac -->6217 / 6480<!-- /m --> code objects | <!-- m:py_band_315_rate -->95.94%<!-- /m --> | <!-- m:py_band_315_modules -->199<!-- /m --> | tag, schedule |
