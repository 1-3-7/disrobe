...
Type-name resolution is validated at 528/528 on Go 1.26.3. UPX-on-Go is auto-chained: `disrobe auto` unpacks the UPX layer first, then recovers the Go symbols underneath.
