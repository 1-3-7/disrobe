...
|---|---|---|
| Python bytecode | <!-- m:py_stdlib_full_pct -->95.09%<!-- /m --> per-code-object equivalence on the full CPython 3.14 stdlib (<!-- m:py_stdlib_full_count -->17378 of 18276<!-- /m -->); <!-- m:py_stdlib_pinned_pct -->96.51%<!-- /m --> on the pinned 200-module corpus (<!-- m:py_stdlib_pinned_count -->6067 of 6286<!-- /m -->). Whole-module exact, where a module counts only if all of its code objects pass: 123 of <!-- m:py_stdlib_pinned_modules -->200<!-- /m --> modules on the pinned corpus | recompile on CPython 3.14.5, opcode diff |
