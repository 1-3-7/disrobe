...
| Containers | <!-- m:containers_formats -->101<!-- /m --> formats declared with an in-tree extractor, <!-- roster-breadth:containers-exercised -->39<!-- /roster-breadth --> of them driven to member bytes by a committed input | extraction over the committed corpus, pinned per format |
