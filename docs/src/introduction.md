...
|---|---|---|
| Python bytecode | <!-- m:py_stdlib_full_pct -->92.43%<!-- /m --> per-code-object equivalence on the full CPython 3.14 stdlib (<!-- m:py_stdlib_full_count -->16880 of 18262<!-- /m -->); <!-- m:py_stdlib_pinned_pct -->96.26%<!-- /m --> on the pinned 200-module corpus (<!-- m:py_stdlib_pinned_count -->6051 of 6286<!-- /m -->) | recompile on CPython 3.14.5, opcode diff |
