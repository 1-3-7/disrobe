...
|---|---|---|
| Python bytecode | <!-- m:py_stdlib_full_pct -->92.43%<!-- /m --> per-code-object equivalence on the full CPython 3.14 stdlib (16880 of 18262); <!-- m:py_stdlib_pinned_pct -->95.35%<!-- /m --> on the pinned 200-module corpus (5920 of 6286) | recompile on CPython 3.14.5, opcode diff |
