...
- [Supported families catalog](./catalog.md)
- [Anti-analysis defeat](./anti-analysis.md)
- [Queryable IR and capabilities](./query.md)
- [Recon, prowl, and indicators](./frisk.md)
...
- [BEAM (Erlang / Elixir)](./languages/beam.md)
- [Swift / Objective-C](./languages/swift.md)
- [ActionScript 3 / Flash](./languages/as3.md)
- [Mobile (Hermes / Flutter)](./languages/mobile.md)
- [Python pickle](./languages/pickle.md)
- [Shell / PowerShell](./languages/shell.md)
- [Containers and archives](./languages/containers.md)
...
- [Batch directory processing](./cli/batch.md)
- [Run reports](./cli/report.md)
...
- [Editor plugins](./integrations/editor-plugins.md)
