...
| `wasm` | Analyze / decompile (JSON / Rust / TypeScript / WAT / C) / catalog <!-- m:wasm_direct_helpers -->4<!-- /m --> direct-helper families; 3 transformations run through `wasm deob`, while Tigress-via-Emscripten and wasm-name-obfuscator detect + classify. |
