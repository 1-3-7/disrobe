...
export const commandGroups = [
  ...
  { title: "Languages and runtimes", commands: ["py", "js", "wasm", "native", "jvm", "apk", "dotnet", "hermes", "macho", "lua", "php", "shell", "ruby", "beam", "as3", "pickle", "go", "swift", "flutter", "mobile"] },
...
export function publicCommands(help) {
  ...
  const names = [...section.matchAll(/^  ([a-z][a-z0-9-]*)\s{2,}/gmu)].map((match) => match[1]);
