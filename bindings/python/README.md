...
See `help(disrobe)` for the full function list and per-function docstrings.
...
| mach-o | `macho_dump` |
| jvm / android | `jvm_parse_class`, `jvm_parse_dex`, `jvm_detect`, `jvm_backends` |
| .net | `dotnet_parse_pe`, `dotnet_parse_metadata`, `dotnet_detect`, `dotnet_analyze`, `dotnet_backends` |
...
All functions raise `disrobe.DisrobeError` on failure.
