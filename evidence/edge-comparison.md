...
| Containers and firmware | <!-- roster-breadth:containers-exercised -->33<!-- /roster-breadth --> of <!-- roster-breadth:containers-declared -->100<!-- /roster-breadth --> declared formats write member bytes from a committed input | binwalk, unblob, 7-Zip | same archive and firmware set, member-byte diff |
