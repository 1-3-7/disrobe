...
|---|---|---|---|
| Python `.pyc` | <!-- m:py_stdlib_full_pct -->95.09%<!-- /m --> full CPython 3.14 stdlib; <!-- m:py_stdlib_pinned_pct -->96.53%<!-- /m --> pinned corpus, both recompile-equivalence | pycdc, pylingual, uncompyle6, decompyle3 | same `.pyc` corpus, same recompile oracle |
