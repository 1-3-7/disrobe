...
- floor: 90.00 (holds)
- gate source: crates/disrobe-pass-py-decompile/tests/arbitrary_recompile_gate.rs:34 (OBJECT_PCT_FLOOR 90.0); harness crates/disrobe-pass-py-decompile/tests/harness/py_arbitrary_measure.py over the 200-module pinned corpus; measured live 96.05 (6038 of 6286 code objects, 200 of 200 modules, whole-module exact 60.50%, 0 sibling-count collisions) on CPython 3.14 at HEAD 37f98183 (value-form and inline-comprehension boolop recovery across for and async-for iterables, guarded-try returns, compound-if runs, comprehension results, and postfix chains on a boolop operand)
