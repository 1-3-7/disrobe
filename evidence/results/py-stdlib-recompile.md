...
- floor: 90.00 (holds)
- gate source: crates/disrobe-pass-py-decompile/tests/arbitrary_recompile_gate.rs:34 (OBJECT_PCT_FLOOR 90.0); harness crates/disrobe-pass-py-decompile/tests/harness/py_arbitrary_measure.py over the 200-module pinned corpus; measured live 96.26 (6051 of 6286 code objects, 200 of 200 modules) on CPython 3.14 at HEAD cba07b77 (a loop-body pure-and if-guard reassembles into a single if a and b: body, and an inlined break-tail keeps the expression-statement whose completing pop sits at the region boundary)
