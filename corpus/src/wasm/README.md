...
Hand-authored `.wat` (WebAssembly text) sources compile to `.wasm` via `wat2wasm` (from [wabt](https://github.com/WebAssembly/wabt)) & feed `disrobe-pass-wasm-deob` (decompile, defrag, EH lift, opcode-table recovery).
