...
Python source fixtures for Disrobe's Python passes: `disrobe-pass-py-disasm`, `disrobe-pass-py-deob`, `disrobe-pass-pyarmor`, `disrobe-pass-pyinstaller`, `disrobe-pass-nuitka`, and `disrobe-pass-sourcedefender`.
