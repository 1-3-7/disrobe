...
Java 21 sources exercising sealed hierarchies, records, switch-pattern matching, text blocks, generics variance, nested classes, runtime annotations, & module descriptors. They feed any future Java/JVM-bytecode pass.
