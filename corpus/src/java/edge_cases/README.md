...
Java 21 source fixtures covering sealed hierarchies, records, switch-pattern matching, text blocks, generic variance, nested classes, runtime annotations, and module descriptors.
...
From this directory, compile the fixtures with JDK 21 or newer:

```powershell
javac -d out --release 21 LambdaCapture.java SealedHierarchy.java RecordCompact.java SwitchPattern.java TextBlock.java VarInference.java WildcardVariance.java NestedClasses.java RuntimeAnnotation.java GenericBound.java
```
