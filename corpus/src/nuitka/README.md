...
Nuitka target sources live in `../python/`; Nuitka builds run out-of-tree in `.developer/nuitka-build/` so that compiled `.dist/` directories & intermediate `.c`/`.o` files do not pollute `corpus/`.
