...
4. Select V1, V2, V3 preset and save each output as `real_v1.lua`, `real_v2.lua`, `real_v3.lua`.
5. Update `corpus/lua/MANIFEST.toml` with sha256 of each.
6. Add real fixture tests in `crates/disrobe-pass-lua/tests/moonsec_v{1,2,3}_real.rs` and
