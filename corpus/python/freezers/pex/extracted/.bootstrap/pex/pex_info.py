...
class PexInfo(object):
    ...
    def __init__(self, info=None):
        ...
        self._pex_info = dict(info) if info else {}
        self._distributions = self._pex_info.get("distributions", {})


        self._interpreter_constraints = None
        ...
        self._excluded = OrderedSet(self._pex_info.get("excluded", ()))
        self._overridden = OrderedSet(self._pex_info.get("overridden", ()))
