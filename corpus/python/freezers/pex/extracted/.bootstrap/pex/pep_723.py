...
class ParseState(object):
    start_type = attr.ib(default="", init=False)
    start_line = attr.ib(default=0, init=False)
    end_line = attr.ib(default=0, init=False)
...
class ScriptMetadata(object):
    ...
    source = attr.ib(default=_UNSPECIFIED_SOURCE)
