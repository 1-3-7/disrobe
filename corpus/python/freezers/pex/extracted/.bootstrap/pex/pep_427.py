...
class InstallableWheel(object):
    ...
    wheel = attr.ib()
    is_whl = attr.ib(init=False)
    install_paths = attr.ib(default=None)
    zip_metadata = attr.ib(default=None)
...
def install_wheel(
    ...
    compile=False,
    requested=True,
    install_entry_point_scripts=True,
    record_entry_info=False,
    normalize_file_stat=False,
    re_hash=False,
    hermetic_scripts=False,
):
