...
//! End-to-end lift pipeline over real (WAT-compiled) function bodies. Asserts the
//! structured translator emits real signatures and operator semantics, and that the
//! WAT target round-trips through `wat::parse_str`.
