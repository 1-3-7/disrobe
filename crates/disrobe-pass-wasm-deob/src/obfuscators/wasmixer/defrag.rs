...
impl HeapRegion {
    /// Byte span from the lowest to highest observed access, including the final element width.
    #[inline]
    #[must_use]
...
/// Recovers heap regions by clustering a function's memory access patterns.
#[must_use]
