...
///
/// Prepending this to a concatenation of lifted C functions yields one compilable
/// translation unit (`cc -c` / `clang -c`).
#[must_use]
...
/// (multi-level branches lower to `goto` over generated labels).
#[must_use]
