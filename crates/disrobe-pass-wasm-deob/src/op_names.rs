...
const fn explicit_mnemonic(op: &Operator<'_>) -> Option<&'static str> {
    Some(match op {
        ...
        Operator::StructNewDesc { .. } => "struct.new_desc",
        Operator::StructNewDefaultDesc { .. } => "struct.new_default_desc",
        Operator::RefGetDesc { .. } => "ref.get_desc",
        Operator::RefCastDescEqNonNull { .. } => "ref.cast_desc_eq",
        Operator::RefCastDescEqNullable { .. } => "ref.cast_desc_eq_null",
        Operator::BrOnCast { .. } => "br_on_cast",
        Operator::BrOnCastFail { .. } => "br_on_cast_fail",
        Operator::BrOnCastDescEq { .. } => "br_on_cast_desc_eq",
        Operator::BrOnCastDescEqFail { .. } => "br_on_cast_desc_eq_fail",
