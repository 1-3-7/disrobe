...
impl NameRecoveryStats {
    /// Fraction of defined functions that received at least one local name.
    #[inline]
    #[must_use]
...
/// Attaches parameter/local names recovered from DWARF to a module's signatures.
#[cfg(feature = "dwarf")]
#[must_use]
...
/// Attaches names from a source map, keyed by each defined function's body byte range.
#[must_use]
