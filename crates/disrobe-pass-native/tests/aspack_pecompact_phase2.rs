...
/// The emulated path must beat the 1st-pass structural 0% on every present fixture.
#[test]
...
/// The section-granule report must recover `.text` byte-identically and isolate the residual elsewhere.
#[test]
