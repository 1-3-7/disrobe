...
mod tests {
    ...
    fn upx_packed_elf_yields_packer_hits() {
        ...
        let hits = crate::packers::detect(&buf);
        assert!(hits.iter().any(|h| h.packer == crate::packers::Packer::Upx));
    }
}
