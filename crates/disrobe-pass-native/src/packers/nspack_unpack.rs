...
fn unpack_nspack_emulated_with_baseline_inner(
    ...
    let mut output: Vec<u8> = vec![0u8; stream.dsize as usize];
    ...
    Ok(NspackEmulatedReport {
        ...
        original_image_baseline: original_image,
        byte_diff_count,
        byte_diff_pct,
    })
}
