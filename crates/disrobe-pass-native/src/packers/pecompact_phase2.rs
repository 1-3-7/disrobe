...
//! PECompact 2.x phase-2 unpacking driven by the SEH-aware shared x86 stub emulator.
...
/// Runs a PECompact 2.x packed PE through the SEH-aware stub emulator to byte-recover its content.
...
/// Single-steps until control re-enters `[ImageBase + page, ep_packed)`, the recovered OEP.
fn run_until_oep(
    cpu: &mut Cpu,
    host: &mut PecompactHost,
    image_base: u64,
