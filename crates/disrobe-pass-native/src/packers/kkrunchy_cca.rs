...
/// Decompresses a kkrunchy classic stream into `expected_size` bytes.
///
/// # Errors
///
...
/// Locates the CCA range-coder stream in a classic-variant packed image.
///
/// # Errors
///
...
///   trial decode from the candidate offset reaches the gamma stop token.
...
/// Carry-style range encoder used by the unit tests to produce ground-truth streams.
#[cfg(test)]
#[derive(Debug)]
struct CarryEncoder {
    out: Vec<u8>,
