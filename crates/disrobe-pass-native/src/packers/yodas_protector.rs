...
impl YodasProtectorReport {
    /// The maximum per-section similarity to the original across all carved sections.
    #[must_use]
    ...
    /// Whether every carved section matched the original exactly.
    #[must_use]
...
/// Detect-and-carves a Yoda's Protector 1.x packed PE against its independent original.
///
/// # Errors
///
