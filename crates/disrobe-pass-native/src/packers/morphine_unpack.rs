...
//! Morphine structural scaffold with a documented byte-recovery sourcing tail.
...
/// Parsed structural facts about a Morphine-encrypted PE.
...
/// The recovery state for a Morphine unpack attempt.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
/// Parses the structural layout of a Morphine-encrypted PE.
///
/// # Errors
///
...
/// Attempts a Morphine unpack, returning [`MorphineRecovery::SourcingTail`].
///
/// # Errors
///
