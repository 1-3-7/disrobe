...
pub use mew_unpack::{
    AplibInitialState, AplibTrace, MewImport, MewUnpackOutput, aplib_decode_bytetagged,
    aplib_decode_bytetagged_lossy, aplib_decode_bytetagged_lossy_with,
...
impl Packer {
    ...
    pub const fn unpacker_status(self) -> UnpackerStatus {
        match self {
            ...
            Self::Fsg | Self::Petite | Self::Mpress | Self::Nspack | Self::Kkrunchy | Self::Mew => {
