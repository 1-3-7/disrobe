...
//! Themida / WinLicense detect-and-carve, surfacing protected-section geometry without devirtualizing.
...
/// Which Oreans product the carved protected section belongs to, inferred from the section name.
...
/// Detect-and-carves a Themida / WinLicense-protected PE without devirtualizing.
///
/// # Errors
///
