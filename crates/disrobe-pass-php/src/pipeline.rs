...
/// What recovery stage produced the final artifact.
...
/// End-to-end recovery report wiring detection through to recovered output.
...
pub struct RecoveryReport {
    ...
    /// Bytes that remain encrypted/undecoded (runtime-keyed payloads).
...
/// Applies the statically recovered key to the payload, or returns the ciphertext as-is.
