...
/// Self-consistency (involution) of the synthetic stand-in transform only; not real Allatori recovery.
#[test]
...
/// Without an embedded decrypt stub, peel must report detect-only and not fabricate plaintext.
#[test]
