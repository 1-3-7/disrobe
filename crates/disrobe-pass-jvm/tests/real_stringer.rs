...
///
/// String constants are sourced from the UNPROTECTED baseline jar purely as
/// realistic input shapes; they are encrypted with our OWN reference transform
/// and decrypted with its inverse. NOT recovery of Stringer-protected samples.
#[test]
