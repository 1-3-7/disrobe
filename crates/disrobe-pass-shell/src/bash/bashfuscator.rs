    ...
    while i < inner.len() {
        ...
        match next {
            ...
            b'x' | b'X' => {
                ...
                let val: u8 = u8::from_str_radix(&hex[..take], 16).unwrap_or(0);
                out.push(val);
                i += 2 + take;
            }
            b'u' => {
                ...
                let val: u32 = u32::from_str_radix(&hex[..take], 16).unwrap_or(0);
            ...
            c if c.is_ascii_digit() => {
                ...
                let val: u8 = u8::from_str_radix(&oct[..take], 8).unwrap_or(0);
                out.push(val);
                i += 1 + take;
            }
            _ => {
