...
fn skater_signature_detected() {
    ...
    assert!(report.matches.contains_key(&Protector::Skater));
}

#[test]
#[ignore = "FIXTURE PENDING: Skater .NET Obfuscator sample for full string-decrypt"]
fn skater_full_round_trip() {
