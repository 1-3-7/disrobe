...
fn armdot_signature_detected() {
    ...
    assert!(report.matches.contains_key(&Protector::ArmDot));
}
...
#[test]
#[ignore = "FIXTURE PENDING: ArmDot sample for full mutator removal"]
fn armdot_full_round_trip() {
