//! Adversarial-input resilience: malformed PE/CLR/metadata and decompiler inputs must yield a clean
//! `Err` (or a bounded, total result) - never a panic, OOM, or hang.
