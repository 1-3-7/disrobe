...
/// Whether a field name matches the state-machine state-selector shape (`<>N__state`).
#[must_use]
...
/// Whether the type declares a `MoveNext` method (the state-machine driver).
...
/// Classify a type as a state machine from its field/method shape, else `None`.
#[must_use]
...
/// Whether a method is a compiler-generated state-machine helper to hide from output.
#[must_use]
