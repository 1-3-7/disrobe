...
/// Whether a method body is a pure self-contained transform safe to emulate.
#[must_use]
...
/// Scan an image for pure static decoders and emulate each over a range of integer inputs.
...
/// Count the `ldstr` user-string sites in a method body.
#[must_use]
