...
use disrobe_pass_lua::decompile::luajit21::decompile as decompile_luajit21;
...
pub(crate) enum LuaCmd {
    ...
    #[command(about = "detect the Lua dialect and report header fields")]
    Detect {
...
fn decompile(input: PathBuf, out: Option<PathBuf>, emit_kinds: Vec<String>) -> miette::Result<()> {
    ...
    let decompiled: DecompiledChunk = match format {
        ...
        DetectedFormat::LuaJit => decompile_luajit21(&chunk)
