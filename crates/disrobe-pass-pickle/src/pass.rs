...
use crate::reconstruct::{Reconstruction, reconstruct};
use crate::vm::{CallSite, GlobalRef, PickleValue, VmTrace, execute_full};
...
impl LegacyPass for PickleLegacyPass {
    ...
    fn run(&self, artifact: &Artifact) -> CoreResult<Artifact> {
        ...
        let report: PicklePassReport = PicklePassReport {
            ...
            cyclic: trace.cyclic,
            out_of_band_buffers: trace.oob_buffer_count,
            global_refs: trace.global_refs,
            call_graph: trace.call_graph,
            source,
