...
fn parse_ivars(view: &SliceView<'_>, parsed: &ParsedSlice, list_vmaddr: u64) -> Vec<ObjcIvar> {
    ...
    for i in 0..count {
        ...
        let size: u32 = view.read_u32_at(elem_off + 28).unwrap_or(0);
        out.push(ObjcIvar {
            name,
            type_encoding,
            offset,
