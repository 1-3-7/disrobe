...
fn emit_python_libs_search_path() {
    ...
    println!(
        "cargo:warning=disrobe-python: no python3.lib found on PATH. Set PYO3_PYTHON=<path-to-python.exe> or install Python 3.9+ from https://www.python.org/downloads/ to build this crate on Windows."
    );
}
