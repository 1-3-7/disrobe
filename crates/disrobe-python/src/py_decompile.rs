...
///
/// Supports CPython 1.0 through 3.15 & PyPy. When the decompiler cannot
...
/// `python<major>.<minor>` on PATH & report a roundtrip verdict
...
/// `instruction_count`, `text`, & an `llm` bundle.
#[pyfunction]
