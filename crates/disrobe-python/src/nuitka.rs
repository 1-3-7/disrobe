...
/// Detect whether `image_bytes` is a Nuitka-compiled binary and classify
...
/// Classify and extract a Nuitka-compiled image. For onefile variants
/// returns the payload offset, entry count, and compression flag; for
/// signed PEs strips Authenticode and recurses on the inner image.
///
/// Returns a dict including `llm: None` (LLM metadata for the Nuitka pass
/// lands in v0.10).
#[pyfunction]
