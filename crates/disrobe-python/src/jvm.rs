use disrobe_pass_jvm::{
    BackendCapability, ClassFile, DexFile, detect_all, detect_available, parse_classfile, parse_dex,
};
use pyo3::prelude::*;
...
/// field table, method table, and attribute set.
#[pyfunction]
...
/// method ids, and class definitions.
#[pyfunction]
...
/// matched protectors and their markers.
#[pyfunction]
#[pyo3(text_signature = "(class_bytes)")]
