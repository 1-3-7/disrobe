...
pub(crate) fn run(
    ...
    Ok(VersionedOutcome {
        ...
        diagnostics: vec![
            "DR-PYARM-STATIC: v7 in-memory decrypt requires runtime bytes; supply UnpackConfig.runtime_bytes or use unpack_wrapper_text_with_options for file-based flow"
                .to_owned(),
        ],
    })
}
