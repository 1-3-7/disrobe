...
/// Band [3.9, 3.11]: the post-3.8 / pre-exception-table interpreters.
const BAND_ALIASES: &[&str] = &["3.9", "3.10", "3.11"];

/// In-band construct subset for the 3.9-3.11 band; the tuple is the minimum minor each compiles on.
