...
/// Recompiles emitted source with a version-matched interpreter, returning the compile error if any.
...
/// Ceiling on emitted modules that raise a syntax error across the whole-module matrix.
