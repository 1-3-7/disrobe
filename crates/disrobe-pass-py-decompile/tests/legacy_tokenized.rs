...
/// Per-era floors for tokenized equivalence between disrobe's recovered source and the pycdc goldens.
const TOKEN_MATCH_FLOOR_1X: usize = 25;
const TOKEN_MATCH_FLOOR_2X: usize = 80;
const TOKEN_MATCH_FLOOR_3X: usize = 67;

/// Fixtures graded against the vendored source tokens rather than the buggy pycdc golden.
...
/// Every vendored pycdc `xfail/` fixture must decode without crashing.
#[test]
