...
/// Band [3.0, 3.8]: the wordcode-but-pre-3.9 era, recompile-proven on 3.6/3.7/3.8.
const RECOMPILE_ALIASES: &[&str] = &["3.6", "3.7", "3.8"];

/// In-band construct subset that compiles on 3.8, recompiled there for a round-trip proof.
const CASES_38: &[&str] = &[
    "assign_chained",
...
/// Vendored 3.0-3.8 fixtures with irreducible lost-literal surface, excluded from the proof floors.
