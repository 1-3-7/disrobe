...
const CLUSTER_CEILINGS: &[(&str, u64)] = &[
    ("CODE:LOAD_FAST->SETUP_FINALLY", 1),
    ("CODE:LOAD_FAST->LOAD_GLOBAL", 11),
    ("CODE:JUMP->LOAD_FAST", 16),
    ("CODE:POP_TOP->JUMP", 14),
    ("CODE:GET_ITER->STORE_FAST", 13),
    ("CODE:SETUP_FINALLY->LOAD_GLOBAL", 12),
    ("CODE:JUMP->LOAD_CONST", 2),
    ("CODE:LOAD_FAST(arg)->LOAD_FAST(arg)", 7),
    ("CODE:LOAD_GLOBAL(arg)->LOAD_GLOBAL(arg)", 4),
    ("SIBLING_MISSING", 5),
    ("CODE:SETUP_FINALLY->LOAD_FAST", 7),
    ("CODE:JUMP_IF_FALSE->POP_TOP", 6),
