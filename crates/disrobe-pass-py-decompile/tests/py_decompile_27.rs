...
/// Band [1.0, 2.7]: the pre-wordcode Python-1/Python-2 era, recompile-proven only on 2.7.
const RECOMPILE_ALIAS: &str = "2.7";

/// Vendored 1.0-2.7 fixtures with irreducible lost-literal surface, excluded from the proof floors.
