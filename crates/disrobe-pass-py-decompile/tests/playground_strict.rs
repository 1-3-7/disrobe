...
#[test]
#[ignore = "FIXTURE PENDING: needs CPython compile+pyc-load infra for the full 1244-LOC corpus"]
fn strict_full_corpus_roundtrip_placeholder() {
    panic!("full edge_cases.py round-trip pending fixture infrastructure");
}
