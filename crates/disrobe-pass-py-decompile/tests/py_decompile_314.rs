...
/// Band [3.12, 3.15]: the exception-table / `type` / PEP-695 / PEP-750 era; 3.15 is beta-lenient.
const BAND_ALIASES: &[&str] = &["3.12", "3.13", "3.14", "3.15"];
const PRERELEASE_ALIASES: &[&str] = &["3.15"];

/// In-band construct subset for the 3.12-3.15 band; the tuple is the minimum minor each compiles on.
