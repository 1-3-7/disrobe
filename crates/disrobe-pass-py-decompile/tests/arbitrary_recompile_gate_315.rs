...
const OBJECT_PCT_FLOOR: f64 = 95.94;
const BAND_OBJECTS_OK: u64 = 6_217;
const BAND_CODE_OBJECTS: u64 = 6_480;
const BAND_MODULES: u64 = 199;
const BAND_MODULES_EXACT_FLOOR: u64 = 120;
...
fn arbitrary_recompile_equivalence_gate_315() {
    ...
    assert_measurement_is_comparable(&m.cpython_version, &CPYTHON_315, &graded());
    println!(
        "{}",
