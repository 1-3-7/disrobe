...
pub const MAX_OPERANDS: usize = 5usize;

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub struct V8OpcodeSpec {
    pub mnemonic: &'static str,
    pub accumulator_use: AccumulatorUse,
    pub operands: [OperandKind; MAX_OPERANDS],
...
impl V8OpcodeSpec {
    ...
    pub const fn new(
        ...
        let mut padded: [OperandKind; MAX_OPERANDS] = [OperandKind::None; MAX_OPERANDS];
        let mut i: usize = 0;
        while i < operands.len() && i < MAX_OPERANDS {
            padded[i] = operands[i];
            i += 1;
        }
...
const BASE_OPCODES_V10_2: &[V8OpcodeSpec] = &[
    ...
    op("ToName", AccumulatorUse::Read, &[OperandKind::RegOut]),
    ...
    op(
        "JumpLoop",
        AccumulatorUse::None,
        &[OperandKind::UImm, OperandKind::Imm],
    ),
    ...
    op("Debugger", AccumulatorUse::None, &[]),
...
const BASE_OPCODES_V11_3: &[V8OpcodeSpec] = &[
    op("Wide", AccumulatorUse::None, &[]),
    op("ExtraWide", AccumulatorUse::None, &[]),
    op("DebugBreakWide", AccumulatorUse::ReadWrite, &[]),
    op("DebugBreakExtraWide", AccumulatorUse::ReadWrite, &[]),
...
const BASE_OPCODES_V13_6: &[V8OpcodeSpec] = &[
    op("Wide", AccumulatorUse::None, &[]),
    op("ExtraWide", AccumulatorUse::None, &[]),
    op("DebugBreakWide", AccumulatorUse::ReadWrite, &[]),
    op("DebugBreakExtraWide", AccumulatorUse::ReadWrite, &[]),
    ...
    op("ToBooleanLogicalNot", AccumulatorUse::ReadWrite, &[]),
    op("LogicalNot", AccumulatorUse::ReadWrite, &[]),
    op("TypeOf", AccumulatorUse::ReadWrite, &[OperandKind::Idx]),
    op(
        "DeletePropertyStrict",
        AccumulatorUse::ReadWrite,
        &[OperandKind::Reg],
    ...
    op(
        ...
        AccumulatorUse::None,
        &[OperandKind::Idx, OperandKind::Reg, OperandKind::Reg],
    ),
    op(
        "JumpIfToBooleanTrueConstant",
        AccumulatorUse::Read,
    ...
    op(
        "JumpIfForInDone",
        AccumulatorUse::None,
        &[OperandKind::UImm, OperandKind::Reg, OperandKind::Reg],
    ),
    op(
        "SwitchOnSmiNoFeedback",
        AccumulatorUse::Read,
    ...
    op("ForInStep", AccumulatorUse::None, &[OperandKind::RegInOut]),
    op("SetPendingMessage", AccumulatorUse::ReadWrite, &[]),
    op("Throw", AccumulatorUse::Read, &[]),
    op("ReThrow", AccumulatorUse::Read, &[]),
    op("Return", AccumulatorUse::Read, &[]),
...
impl OpcodeTable {
    ...
    pub fn for_node(node: NodeVersion) -> Self {
        match node {
            NodeVersion::Node18 => Self::build(node, "v10.2", BASE_OPCODES_V10_2),
            NodeVersion::Node20 => Self::build(node, "v11.3", BASE_OPCODES_V11_3),
            NodeVersion::Node22 => Self::build(node, "v12.4", BASE_OPCODES_V12_4),
            NodeVersion::Node24 => Self::build(node, "v13.6", BASE_OPCODES_V13_6),
            NodeVersion::Unknown => {
                Self::build(NodeVersion::Unknown, "unknown", BASE_OPCODES_V13_6)
            }
        }
    }
