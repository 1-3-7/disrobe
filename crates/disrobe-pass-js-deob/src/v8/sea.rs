...
/// Node.js Single Executable Application `kMagic` constant (`src/node_sea.h`).
pub const SEA_MAGIC: u32 = 0x0143_DA20;

/// Legacy byte-string sentinel kept for compile-time deprecation of the old symbol.
#[deprecated(
    since = "0.3.0",
...
/// Hard cap bounding any single string-view read from a SEA blob.
