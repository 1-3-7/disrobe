...
pub use bundle::{
    ...
    SourceMapInfo, SourceMapLocation, SourceTreeRecovery, SynthesizedSourceMap,
    UnbundleGraphResult, UnbundleResult, ViteManifest, ViteManifestEntry, auto_unbundle,
    build_id_to_path_map, decode_data_url_json, decode_inline_data_url, decode_mappings,
    decode_vlq, detect_amd, detect_browserify, detect_bun, detect_esbuild, detect_parcel,
    detect_rolldown, detect_rollup, detect_systemjs, detect_turbopack, detect_vite,
    detect_webpack4, detect_webpack5, emit_source_maps, encode_mappings, find_source_map,
    merge_reports, parse_source_map, parse_source_map_v3, parse_vite_manifest,
    recover_deployed_source, recover_source_map, recover_source_map_inline,
    recover_source_map_json, recover_source_tree_from_chunks, recover_source_tree_from_js,
    renamed_bindings, rewrite_modules, rewrite_requires, serialize_source_map,
