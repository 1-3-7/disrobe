//! String-literal escape normalization for obfuscator.io `unicodeEscape`
//! output: decodes `\xHH`, `\uHHHH`, and `\u{...}` escapes back to their
//! printable characters inside single/double-quoted literals while leaving
//! quote/backslash/control escapes and template literals untouched. Mirrors
//! webcrack's (MIT) literal canonicalization, reimplemented clean-room over
//! a byte scanner.
