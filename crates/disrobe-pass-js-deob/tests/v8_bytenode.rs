...
/// On real `.jsc` fixtures, asserts magic match, V11/V12 header layout, the `SnapshotDeserializeWall` status, and scraped source strings.
#[test]
...
/// Proves disassembling a real V8 snapshot payload surfaces unknown-opcode/trailing-garbage signal, not a clean Ignition listing.
#[test]
