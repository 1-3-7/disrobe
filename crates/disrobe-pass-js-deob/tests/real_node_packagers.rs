...
/// Asserts the SEA parser yields the real `0x0143DA20` magic and a non-empty `.js` `code_path`.
#[test]
...
/// Asserts the bytenode header parser matches the real Node-18 `.jsc` magic and V11 header layout.
#[test]
