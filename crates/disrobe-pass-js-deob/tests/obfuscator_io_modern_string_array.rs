...
//! Regression coverage for the modern javascript-obfuscator / obfuscator.io
//! string-array layout (self-reassigning provider + rotation IIFE + wrapper
//! decoder reached through aliases). These fixtures are the reference output of
//! the public obfuscator.io presets and per-control toggles; recovery must
//! decode real string literals via the bounded sandbox, not merely detect.
