...
/// REAL fixture test: parses an actual `sea-prep.blob` produced by
/// `node --experimental-sea-config` on Node 24.16. The fixture is checked into
/// `corpus/js/sea/sea-prep.blob` (57 bytes, magic `0x0143DA20`); if missing,
/// the test reports a typed skip rather than a fake green.
#[test]
