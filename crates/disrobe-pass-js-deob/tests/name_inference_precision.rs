...
const PINNED_MEMBERSHIP: &[&str] = &[
    ...
    "esbuild/collection|o|predicate|predicate|medium|heuristic",
    ...
    "esbuild/collection|r|list|result|medium|heuristic",
    ...
    "esbuild/collection|t|source|source|low|heuristic",
    ...
    "esbuild/loader|n|query|query|medium|heuristic",
    ...
    "esbuild/widget|f|position|position|low|context",
    "esbuild/widget|i|index|options|low|corpus",
    "esbuild/widget|l|list|subscribe|low|corpus",
    ...
    "esbuild/widget|t|listeners|listeners|medium|heuristic",
    ...
    "terser/collection|e|source|source|low|heuristic",
    ...
    "terser/collection|r|predicate|predicate|medium|heuristic",
    "terser/collection|r|result|selector|low|corpus",
    "terser/collection|r|result|size|low|corpus",
    "terser/collection|t|list|result|medium|heuristic",
    ...
    "terser/widget|e|listeners|listeners|medium|heuristic",
    "terser/widget|i|index|counter|low|corpus",
    "terser/widget|n|position|position|low|context",
