...
$targets = @(
    @{ src = "pebcheck.c";   out = "pebcheck.exe";   libs = "kernel32.lib"; opt = "/O2" },
    @{ src = "stackstr.c";   out = "stackstr.exe";   libs = "kernel32.lib"; opt = "/Od" },
    @{ src = "embedpe.c";    out = "embedpe.exe";    libs = "kernel32.lib"; opt = "/O2" }
)
