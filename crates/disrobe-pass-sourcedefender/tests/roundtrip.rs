...
use disrobe_pass_sourcedefender::{
    AES_IV_LEN, DerivedKey, InlinedExtractOptions, KeyCache, PYE_BEGIN_MARKER, PYE_END_MARKER,
    PyeCodePayload, derive_aes_key, extract_inlined,
};
...
fn roundtrip_single_file_via_cache() {
    ...
    assert!(matched, "expected source payload to round-trip");
