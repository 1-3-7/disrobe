...
#[test]
fn compiled_closure_parses_to_bytecode_body() {
...
#[test]
fn standalone_bytecode_object_parses() {
...
#[test]
fn expression_vector_parses_and_recovers_symbols() {
...
#[test]
fn s4_object_parses_with_slots_as_attributes() {
...
#[test]
fn namespace_referenced_function_parses() {
    let obj: RdsObject =
...
#[test]
fn nested_list_with_compiled_member_parses() {
...
#[test]
fn raw_and_logical_list_parses() {
...
#[test]
fn raw_vector_bytes_recovered_exactly() {
...
#[test]
fn complex_vector_values_recovered() {
...
#[test]
fn s4_object_class_and_slots_recovered() {
...
#[test]
fn environment_bindings_recovered() {
...
#[test]
fn altrep_compact_intseq_materialized() {
...
#[test]
fn external_pointer_address_marked_runtime_only() {
