...
/// Shortest run of consecutive string values that qualifies a candidate as a real constant table.
const MIN_STRING_RUN: usize = 3;

/// Hard ceiling on container length to reject a mis-aligned varint.
