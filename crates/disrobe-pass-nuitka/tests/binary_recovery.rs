...
//! End-to-end recovery against a real Nuitka 4.1.1 `--onefile` binary.
...
/// blake3 of each onefile-extracted entry.
...
/// Extract the inner compiled module (`hello.dll`) carried by the onefile payload.
...
/// Parse the function names declared in Nuitka's `.pyi` stub.
