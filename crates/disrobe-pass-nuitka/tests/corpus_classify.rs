...
/// Resolves the real onefile fixture, building it via Nuitka when on PATH and absent.
...
/// Decodes a real Nuitka onefile payload and asserts recovered file names, sizes, and content.
#[test]
