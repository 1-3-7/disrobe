...
pub use flutter::{
    ...
    DartStaticRecovery, DartStringPool, DartStringRole, DemangledName, DispatchSite,
    FlutterApkLayout, FlutterObfuscationMap, ImageHeader, KernelClass, KernelLibrary,
