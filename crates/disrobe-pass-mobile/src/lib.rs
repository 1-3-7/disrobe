...
pub use hermes::{
    ...
    JsLiftReport, LiteralValue, OpcodeCount, RecoveredRegExp, RegExpTableEntry,
    SmallFunctionHeader, StructureDecline, bigint_literal as hermes_bigint_literal,
    ...
    lift_to_js_surface as hermes_lift_to_js_surface, opcode_label as hermes_opcode_label,
