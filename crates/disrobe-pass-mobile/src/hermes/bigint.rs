...
/// Upper bound on bigint storage bytes converted to a decimal string per literal.
const MAX_BIGINT_BYTES: usize = 4096;

/// Recovers the JS source form (`<decimal>n`) of every bigint literal in a module.
#[must_use]
...
/// Computes the magnitude of a negative little-endian two's-complement value.
#[must_use]
...
/// Converts a little-endian unsigned magnitude to its base-10 string.
#[must_use]
