//! Reconstructs multi-clause Erlang function heads from the single merged body the BEAM compiler emits per `func_info`.
...
/// Identifies the argument register a `case` subject dispatches on.
