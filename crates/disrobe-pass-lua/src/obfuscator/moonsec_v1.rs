...
/// Recovers `MoonSec` V1's plaintext string pool.
///
/// The pool is a sequence of `string.char(...)` numeric byte arrays. Only arrays
/// that decode to printable (or whitespace) text are surfaced, suppressing
/// opcode-table numeric noise.
#[must_use]
