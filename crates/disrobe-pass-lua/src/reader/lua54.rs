...
fn read_proto(
    ...
    let mut upvalues: Vec<LuaUpvalueName> = Vec::with_capacity(c.bounded_capacity(upval_count, 3));
    ...
    let mut source_lines: Vec<u32> = Vec::with_capacity(c.bounded_capacity(line_info_count, 1));
