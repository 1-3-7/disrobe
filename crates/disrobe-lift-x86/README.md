...
This example requires both `disrobe-lift-x86` and `disrobe-sleigh` as direct Cargo dependencies.

```rust
use disrobe_lift_x86::decode_block_x86;
use disrobe_sleigh::lifter::DecodedBlock;

let instructions: &[u8] = &[0x48, 0x01, 0xd0];
let block: DecodedBlock = decode_block_x86(instructions, 0x401000, 64);
