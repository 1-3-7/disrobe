...
pub struct FunctionFeatures {
    ...
    reference_corroboration_required: bool,
}
...
impl FunctionFeatures {
    pub fn new(id: FunctionId, references: impl IntoIterator<Item = DataReference>) -> Self {
        Self {
            ...
            reference_corroboration_required: false,
        }
    }
    ...
    #[must_use]
    pub const fn requiring_reference_corroboration(mut self) -> Self {
        self.reference_corroboration_required = true;
        self
    }

    #[must_use]
    pub const fn requires_reference_corroboration(&self) -> bool {
        self.reference_corroboration_required
    }
